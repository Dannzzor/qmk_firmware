 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Dn|Adjust| Ctrl | Alt  | GUI  |Shift |Shift |      |Space |Space | Left | Down |  Up  | Right|   \  |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     EQL,LCTRL, A  , S  , D  , F  , G  ,      H  , J  , K  , L  ,SCLN,QUOT,ENT ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     RASE,LSFT,LSFT, Z  , X  , C  , V  ,      B  , N  , M  ,COMM,DOT ,SLSH,HOME,//END ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LOWR,AJST,LCTL,LALT,LGUI,LSFT,LSFT,      SPC, SPC,LEFT,DOWN, UP ,RGHT,BSLS
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
